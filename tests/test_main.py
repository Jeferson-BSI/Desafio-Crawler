...
# async def test_search_diaries_valid_date(page):
#     publication_date = "2024-10-04"
#     url = search_diaries(publication_date, BASE_URL)

#     assert url is not None, "A URL do PDF não deve ser None para uma data válida."
#     assert url.startswith(BASE_URL), "A URL do PDF deve começar com o domínio correto."

# def test_handle_hash_md5(page):
#     publication_date = "2024-10-04"
#     url = search_diaries(publication_date, BASE_URL)
...
# def test_search_diaries_invalid_date(page):
